...
const translations = {
  en: {
    ...
    confirmPaymentPrompt: "Please review the payment details before signing.",
    recipient: "Recipient",
    payoutAmount: "Payout",
    cancel: "Cancel",
  ...
  vi: {
    ...
    confirmPaymentPrompt: "Vui lòng xem lại chi tiết thanh toán trước khi ký.",
    recipient: "Người nhận",
    payoutAmount: "Số tiền nhận",
    cancel: "Hủy",
