...
const translations = {
  en: {
    ...
    incomingSplits: "Splits paying you",
    noIncomingSplits: "No splits pay you yet.",
    noIncomingSplitsDesc: "When someone adds you as a recipient in a split, it will appear here.",
    copy: "Copy",
    yours: "yours",
    mutable: "mutable",
    locked: "locked",
  ...
  vi: {
    ...
    incomingSplits: "Danh sách chia trả cho bạn",
    noIncomingSplits: "Chưa có danh sách chia nào trả cho bạn.",
    noIncomingSplitsDesc: "Khi ai đó thêm bạn làm người nhận trong danh sách chia, nó sẽ xuất hiện ở đây.",
    copy: "Sao chép",
    yours: "của bạn",
    mutable: "có thể sửa",
    locked: "đã khóa",
